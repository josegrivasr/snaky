    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-900 via-gray-800 to-gray-900 p-2 sm:p-4 md:p-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative">
          <div className="mb-4 sm:mb-6 md:mb-8">
            ...
            />
            <div className="flex items-start justify-between px-64 max-sm:px-9 max-md:px-12 text-white">
              <div className="text-left">
                <span className="text-base sm:text-2xl font-semibold">Select your code</span>
              </div>
              <div className="flex items-center justify-center my-2">
                <span className="text-white text-lg">|</span>
              </div>
              <div className="text-white text-xs sm:text-sm text-left">
                <p><span className="font-semibold">Mon - Fri:</span> 5:00 PM to 10:30 PM</p>
                <p><span className="font-semibold">Sat - Sun:</span> All Day</p>
              </div>
            </div>
          </div>

...
// Product Card Component with proper image loading
    ...
    >
      ...
      <div className={`p-2 sm:p-3 flex items-center justify-center flex-1 ${
        ...
        <ImageLoader
          ...
          fallback={<div className="text-4xl sm:text-5xl md:text-6xl">🛍️</div>}
          loadingComponent={<div className="animate-spin rounded-full h-8 w-8 border-b-2 border-gray-400"></div>}
        />
      </div>
